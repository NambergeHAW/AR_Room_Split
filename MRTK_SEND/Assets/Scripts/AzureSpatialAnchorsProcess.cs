...
{
    public class AzureSpatialAnchorsProcess : DemoScriptBase
    {
        ...
        {
            Debug.Log(">>Azure Spatial Anchors Process Script Start");
            ...
            Debug.Log("Azure Spatial Anchors Process script started");
        }
        ...
        {
            gameObject.GetComponent<AzureSpatialAnchorsBasicDemoScript>().anchoredObjectPrefab = furniture;
        }
